...
class WazuhAlertInput(BaseModel):
    ...
    timestamp: Optional[str] = None  # Handle both @timestamp and timestamp
    rule: Rule
    agent: Optional[Agent] = None  # Make optional
    ...
    @classmethod
    def from_wazuh_alert(cls, alert_data: dict):
        """Create from raw Wazuh alert data, handling @timestamp field."""
